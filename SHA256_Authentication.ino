...
void handleLogin() {
  ...
  if (server.hasArg("USERNAME") && server.hasArg("PASSWORD")) {
    if (server.arg("USERNAME") == "admin" &&  server.arg("PASSWORD") == "4813494d137e1631bba301d5acab6e7bb7aa74ce1185d456565ef51d737677b2") {
  ...
  content +="}\n";
  content +="function encodeMyHtml(){var htmlToEncode = document.getElementById('password').value; \n";
  content +="var str = String(htmlToEncode) ; \n";
  content +="var newString = SHA256(str); \n";
  content +="var encodedHtml = escape(htmlToEncode); \n";
  content +="document.getElementById('password').value=newString; return true;} </script>\n";
...
void handleRoot() {
  ...
  String content = "<html><body><H2>Authentication using SHA256 Encryption Protocol</H2><br>";
